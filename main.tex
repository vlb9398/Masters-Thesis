...
\subsection{Expected SZ Measurements \& Noise Sources for TIME}
...
The entire instrument is housed in a closed cycle cryostat with 5 cooling stages ranging from 50 K, using pulse tube refrigeration, down to the base temperature of 250 mK, utilizing 3He sorption. The cryostat is shown below in Figure ~\ref{fig:jon1} without the aluminum shields.

\begin{figure}[h!]
\centering
\captionsetup{width=0.95\textwidth}
\includegraphics[width=0.95\textwidth]{jon1.png}
...
\centering
\captionsetup{width=0.95\textwidth}
\includegraphics[width=0.95\textwidth]{jon2.png}
\caption[TIME Spectrometer Banks and Detector Modules -(\cite{Hunacek2016})]{Schematic of one of two spectrometer banks. The 16 input feedhorns take input from the optical path from the telescope into the cryostat, where the signal is incident on the curved diffraction gratings, and finally onto the spider mesh bolometer detector arrays (\cite{Hunacek2016}).}
\label{fig:jon2}
\end{figure}
